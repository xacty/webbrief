...
await test('all exported tools register without throwing', async () => {
  ...
  for (const expected of ['projects_list', 'assets_list', 'assets_export', 'assets_convertAndSave', 'sections_list', 'comments_list', 'pages_create', 'pages_delete', 'pages_rename']) {
